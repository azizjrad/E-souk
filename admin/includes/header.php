            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown">
                        ...
                        <li><a class="dropdown-item" href="<?php echo ROOT_URL; ?>public/pages/index.php" target="_blank"><i class="fas fa-external-link-alt me-2"></i>Voir le Site</a></li>                            <li><hr class="dropdown-divider"></li>
        ...
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar">
                <div class="sidebar-sticky">
                    ...
                    <div class="sidebar-heading">Gestion du Magasin</div>
                    <ul class="nav flex-column">
                        <li class="nav-item">
